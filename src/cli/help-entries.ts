/**
 * Help text for every built-in CLI command.
 *
 * Split out of `src/cli/help.ts` (#2833): that file was 294 lines against the 250-line rule,
 * and ~200 of them were this table. Data and the code that renders it are genuinely separate
 * concerns — adding a command should not touch the renderer, and changing the layout should not
 * touch the table.
 */
...
export const SUBCOMMAND_HELP: CliHelpEntry[] = [
